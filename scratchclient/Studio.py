...
class Studio:
    ...
    def open_to_public(self):
        requests.put(
            f"https://scratch.mit.edu/site-api/galleries/{str(self.id)}/mark/open/",
            headers=self._headers,
        )

    def close_to_public(self):
        requests.put(
            f"https://scratch.mit.edu/site-api/galleries/{str(self.id)}/mark/closed/",
            headers=self._headers,
        )

    def follow(self):
        return requests.put(
            f"https://scratch.mit.edu/site-api/users/bookmarkers/{str(self.id)}/add/?usernames={self._client.username}",
            headers=self._headers,
        ).json()

    def unfollow(self):
        return requests.put(
            f"https://scratch.mit.edu/site-api/users/bookmarkers/{str(self.id)}/remove/?usernames={self._client.username}",
            headers=self._headers,
        ).json()
    ...
    def toggle_commenting(self):
        ...
        requests.post(
            f"https://scratch.mit.edu/site-api/comments/gallery/{str(self.id)}/toggle-comments/",
            headers=headers,
        )
    ...
    def post_comment(self, content, parent_id="", commentee_id=""):
        ...
        requests.post(
            f"https://scratch.mit.edu/site-api/comments/gallery/{str(self.id)}/add/",
            headers=headers,
    ...
    def accept_curator(self):
        ...
        requests.put(
            f"https://scratch.mit.edu/site-api/users/curators-in/{str(self.id)}/add/?usernames={self._client.username}",
            headers=headers,
        )
    ...
    def promote_curator(self, user):
        ...
        requests.put(
            f"https://scratch.mit.edu/site-api/users/curators-in/{str(self.id)}/promote/?usernames={self._client.username}",
            headers=headers,
        )
